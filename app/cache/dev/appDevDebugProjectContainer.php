...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'bonnezannonces_user.registration.form.type' => 'getBonnezannoncesUser_Registration_Form_TypeService',
    ...
    /**
     * Gets the 'bonnezannonces_user.registration.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Bonnezannonces\UserBundle\Form\Type\RegistrationFormType A Bonnezannonces\UserBundle\Form\Type\RegistrationFormType instance.
     */
    protected function getBonnezannoncesUser_Registration_Form_TypeService()
    {
        return $this->services['bonnezannonces_user.registration.form.type'] = new \Bonnezannonces\UserBundle\Form\Type\RegistrationFormType('Bonnezannonces\\UserBundle\\Entity\\User');
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'bonnezannonces', 'user' => 'root', 'password' => 'Migaloo_7', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Bonnezannonces/MainBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Bonnezannonces/UserBundle/Entity')));
        ...
        $d->addDriver($b, 'Bonnezannonces\\MainBundle\\Entity');
        $d->addDriver($b, 'Bonnezannonces\\UserBundle\\Entity');
        $d->addDriver($c, 'FOS\\UserBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('MainBundle' => 'Bonnezannonces\\MainBundle\\Entity', 'UserBundle' => 'Bonnezannonces\\UserBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_2f434bbabb6c6b414b2f00fa5319c3b874cbf27ac19f7b7f4799e85ba2e524a6');
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Bonnezannonces\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form'] = $this->get('form.factory')->createNamed('fos_user_registration_form', 'bonnezannonces_user_inscription', NULL, array('validation_groups' => array(0 => 'Registration', 1 => 'Default')));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Bonnezannonces\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Bonnezannonces\\UserBundle\\Entity\\User');
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Bonnezannonces/MainBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Bonnezannonces/AssetsBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Bonnezannonces/UserBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Bonnezannonces/MainBundle/Resources/views'), 'Main');
        $instance->addPath(($this->targetDirs[3].'/src/Bonnezannonces/AssetsBundle/Resources/views'), 'Assets');
        $instance->addPath(($this->targetDirs[3].'/src/Bonnezannonces/UserBundle/Resources/views'), 'User');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('r8S7495wBClR2yb0q3YI71X257902581bRj');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MainBundle' => 'Bonnezannonces\\MainBundle\\MainBundle',
                'AssetsBundle' => 'Bonnezannonces\\AssetsBundle\\AssetsBundle',
                'UserBundle' => 'Bonnezannonces\\UserBundle\\UserBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'bonnezannonces',
            'database_user' => 'root',
            'database_password' => 'Migaloo_7',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'fr',
            'secret' => 'r8S7495wBClR2yb0q3YI71X257902581bRj',
            ...
            'kernel.secret' => 'r8S7495wBClR2yb0q3YI71X257902581bRj',
            ...
            'fos_user.model.user.class' => 'Bonnezannonces\\UserBundle\\Entity\\User',
            ...
            'fos_user.registration.form.type' => 'bonnezannonces_user_inscription',
