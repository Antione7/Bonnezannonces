...
class AnnonceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MainBundle:Annonce')->findBy(array('idUser'=>$user));
     ...
     * @Method("POST")
     * @Template("MainBundle:Annonce:new.html.twig")
     */
    public function createAction(Request $request)
    {
        $user = $this->get('security.context')->getToken()->getUser();
        $entity = new Annonce($user);
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('annonce_show', array('id' => $entity->getIdAnnonce())));
        }
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MainBundle:Annonce')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("MainBundle:Annonce:edit.html.twig")
     */
